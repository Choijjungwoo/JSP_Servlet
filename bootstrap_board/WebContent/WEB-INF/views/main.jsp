        ...
        <div class="col-md-6">
        	<div class="panel box box-primary">
        		<div class="box-header with-border">
        			...
        			<a href="<%=request.getContextPath() %>/member/list" class="btn btn-info bg-aqua pull-right" style="padding:0 2px;">+더보기</a>
        		</div>
        		<div class="box-body" style="text-align:center;">
	                ...
	                <c:forEach var="member" items="${memberList}" varStatus="status">
	                	<tr>
	                		<td>${status.count }</td>
	                		<td>
	                			<a href="<%=request.getContextPath() %>/member/detail?id=${member.id }">${member.id }</a>
	                		</td>
	                		<td>${member.email }</td>
	                		<td>${member.phone }</td>
	                	</tr>
        ...
        <div class="col-md-6">
        	<div class="panel box box-primary">
        		<div class="box-header with-border"">
        			...
        			<a href="<%=request.getContextPath() %>/board/listSearch" class="btn btn-info bg-aqua pull-right" style="padding:0 2px;">+더보기</a>
        		</div>
        		<div class="box-body">
        			<table class="table table-bordered">
						<tr>
						...
						<c:forEach items="${boardList }" var="board">
							<tr>
								...
								<a href="<%=request.getContextPath() %>/board/detail?bno=${board.bno }">
        ...
        <div class="col-md-12">
        	<div class="panel box box-primary">
        		<div class="box-header with-border"">
        			...
        			<a href="<%=request.getContextPath() %>/pds/list" class="btn btn-info bg-aqua pull-right" style="padding:0 2px;">+더보기</a>
        		</div>
        		<div class="box-body">
        			<table class="table table-bordered">
						<tr>
						...
						<c:forEach items="${pdsList }" var="pds">
							<tr>
								...
								<a href="<%=request.getContextPath() %>/pds/detail?pno=${pds.pno }">
