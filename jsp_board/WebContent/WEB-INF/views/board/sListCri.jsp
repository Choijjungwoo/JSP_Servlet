    ...
    <section class="content-header">
      <h1>
        ...
        <button id='newBtn' class="btn btn-primary"
        	    onclick="javascript:location.href='regist${pageMaker.makeQuery(pageMaker.cri.page)}';">글등록</button>
      </h1>
      <ol class="breadcrumb">
						...
						<table class="table table-bordered">
							...
							<c:forEach items="${dataMap.boardList }" var="board">
								<tr>
									...
									<a href="detail${pageMaker.makeQuery(pageMaker.cri.page) }&bno=${board.bno }">
					...
					<div class="box-footer">
						<div class="text-center">
							<ul class="pagination">
								...
								<li><a href="listSearch${pageMaker.makeQuery(1)}">&lt;&lt;</a>						
								<li>
									<a href="listSearch
								...
								<li <c:out value="${pageMaker.cri.page == pageNum?'class =active':''}"/>>
									<a href="listSearch${pageMaker.makeQuery(pageNum) }" >${pageNum }</a></li>
								</c:forEach>
								<li><a href="listSearch
								...
								">&gt;</a></li>
								<li><a href="listSearch${pageMaker.makeQuery(pageMaker.realEndPage) }">&gt;&gt;</a>
...
<script>
	...
	$('#searchBtn').on('click',function(e){
		...
		jobForm.attr("action","listSearch").attr("method","get");
		jobForm.submit();
	});
